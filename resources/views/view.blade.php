...
<body>
                ...
                <div class="modal-body add_epmployee">
                    ...
                    <form id="saveform" method="post">
                        ...
                        <div class="modal-footer" style="height: 45px;">
                            <button type="button" class="btn btn-secondary btn-xs py-0 saveFormClose" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary btn-xs py-0 addEmployee" id="save" onclick="addEmployee();">Save</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editform" method="post">
                        ...
                        <br>
                        <div class="modal-footer" style="height: 45px;">
                            <button type="button" class="btn btn-secondary btn-xs py-0" data-bs-dismiss="modal">Close</button>
    ...
    <script>
        ...
        $('.saveFormClose, .addEmployee').click(() => {
            $('#nameError2').text('');
